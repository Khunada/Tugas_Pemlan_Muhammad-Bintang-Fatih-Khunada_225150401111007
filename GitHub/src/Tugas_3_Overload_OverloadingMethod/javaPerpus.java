package Tugas_3_Overload_OverloadingMethod;
...
private int halaman;
private String[] penulisbanyak; private String sinopsis; private int jml_kata;
private double tngkt_kesamaan; private int biaya_buku; private int royalti_persen; private int
Royalti;
private int penjualan;
public Perpus(){
}
public Perpus(String kategori1, String penulis1, String judul1, String bahasa1, String penerbitan1,
String edisi1, String halaman1, String sinopsis1){
}
public String[] getpenulisbanyak() { return penulisbanyak;
}
public void setPenulisbanyak(String[] s) { this.penulisbanyak = s;
}
public void setKategori(String s) { kategori = s;
}
public void setPenulis(String s) { penulis = s;
}
...
public void setPenerbitan(String s) { penerbitan = s;
}
public void setEdisi(String i) { edisi = i;
}
...
public void setbiayaBuku(int i){ biaya_buku = i;
}
public void royaltiPersen(int i){ royalti_persen = i;
}
public void setSinopsis(String s){ sinopsis = s;
penghitungKata();
}
public void penghitungKata(){
String penghitung = sinopsis;
int sum = 0;
for(int j=0; j<penghitung.length(); j++){ if(penghitung.charAt(j)==' '){
sum++;
}
}
if(sum>0){
...
public double ItungKesamaan(Perpus o1){ int same = 0; if(this.kategori.equals(o1.kategori)){
same ++;
}
...
same ++;
} if(this.penerbitan.equals(o1.penerbitan)){ same ++;
}
tngkt_kesamaan = same*20;
displayItungKesamaan(o1);
return tngkt_kesamaan;
}
private void displayItungKesamaan(Perpus o1){ System.out.println("Tingkat kesamaan kata : " +
tngkt_kesamaan);
}public int hitungRoyalti(int biaya){ this.biaya_buku = biaya;
Royalti = (penjualan*biaya_buku*10/100);
return Royalti;
}
public int hitungRoyalti(int biaya, int persen){ this.biaya_buku = biaya;
this.royalti_persen = persen;
Royalti = (penjualan*biaya_buku*royalti_persen)/100; return Royalti;
}
...
public void simpanFile(String namaFile){ try{
BufferedWriter tulis = new BufferedWriter(new FileWriter(namaFile));
tulis.write(judul + "; " + penulis);
tulis.close();
}catch (IOException exception){ System.out.println("Error : " + exception.getMessage()); }
}
public void displayMessage() {
System.out.println(judul);
System.out.println("Informasi Buku: "); System.out.println("Kategori : " + kategori);
if (this.penulisbanyak == null) { System.out.println("Penulis : " + penulis);
} else {
System.out.println("Penulis : " + Arrays.toString(penulisbanyak).replace("[", "").replace("]", ""));
}
System.out.println("Penerbitan : " + penerbitan); System.out.println("Edisi : " + edisi);
System.out.println("Jumlah Halaman : " + halaman); System.out.println("Bahasa : " + bahasa);
if(jml_kata>=10){
...
b1.setPenerbitan("LondonGeorge Allen & Unwin Ltd 1952"); b1.setBahasa("Inggris");
b1.setEdisi("Kedua");
b1.setHalaman(814);
...
b1.displayMessage(); System.out.println("=====================================");
...
"Sa’diyah El Adawiyah", "Suwarto", "Aminah Swarnawati", "AgungPrabowo", "Kurnia Arofah", "Sri Budi Lestari", "Edi antoso","M as’Amah"}); b2.setPenerbitan("ASPIKOM 2015");
...
b2.displayMessage(); System.out.println("=====================================");
...
b3.setPenerbitan("Mizan Pustaka 2014"); b3.setBahasa("Indonesia");
b3.setEdisi("-");
b3.setHalaman(800);
b3.setSinopsis("Buku ini becerita tentang sejarah filsafat hingga abad ke-20 agar lebih dikenal oleh banyak orang"); b3.setPenjualan(15);
b3.hitungRoyalti(35000, 10);
b3.displayMessage(); System.out.println("=====================================");
Perpus b4 = new Perpus();
b4.setJudul("Filsafat Kata");
b4.setKategori("Filsafat");
b4.setPenulis("Reza Alexander Antonius Wattimena"); b4.setPenerbitan("Evolitera 2011");
...
b4.displayMessage(); System.out.println("=====================================");
Perpus b5 = new Perpus();
b5.setJudul("Dinamika Pendidikan Islam: Perspektif Historis"); b5.setKategori("Sejarah");
b5.setPenulis("Dr. Siswanto, M.Pd.I");
b5.setPenerbitan("Pena Salsabila 2013"); b5.setBahasa("Indonesia");
b5.setEdisi("-");
b5.setHalaman(190);
...
b5.displayMessage(); System.out.println("=====================================");
Perpus b6 = new Perpus();
b6.setJudul("Penulisan dan Penghimpunan Hadis: Kajian Historis"); b6.setKategori("Sejarah");
...
b6.displayMessage(); System.out.println("=====================================");
...
b9.displayMessage(); System.out.println("=====================================");
Perpus b10 = new Perpus();
b10.setJudul("Modul Pembelajaran dan Praktikum Tes Psikologi"); b10.setKategori("Psikologi");
b10.setPenulis("Zainul Anwar");
b10.setPenerbitan("Psychology Forum 2021"); b10.setBahasa("Indonesia");
b10.setEdisi("-");
b10.setHalaman(60);
b10.setSinopsis("Buku ini membahas tentang pengertian tes psikologi, macam-macamnya hingga prinsip pelaksanaanya"); b10.setPenjualan(25);
b10.hitungRoyalti(50000);
b10.displayMessage(); System.out.println("=====================================");
Perpus b11 = new Perpus();
b11.setJudul("Nasionalisme Indonesia Kini dan di Masa Depan"); b11.setKategori("Politik");
b11.setPenulis("Benedict Anderson");
b11.setPenerbitan("Anjing Galak Penerbitan 2010"); b11.setBahasa("Indonesia");
b11.setEdisi("-");
b11.setHalaman(42);
b11.setSinopsis("Buku ini menceritakan tentang rasa nasionalisme bangsa Indonesia sejak zaman kemerdekaan hingga saat ini"); b11.setPenjualan(15);
b11.hitungRoyalti(30000, 10);
b11.displayMessage(); System.out.println("=====================================");
Perpus b12 = new Perpus();
b12.setJudul("Nyanyi sunyi seorang bisu: Catatan-catatan dari P. Buru");
b12.setKategori("Politik");
b12.setPenulis("Pramoedya Ananta Toer"); b12.setPenerbitan("Lentera 1995");
...
b12.displayMessage(); System.out.println("=====================================");
Perpus b13 = new Perpus();
b13.setJudul("Laut Bercerita");
b13.setKategori("Fiksi");
b13.setPenulis("Leila S. Chudori"); b13.setPenerbitan("Gramedia Pustaka Utama 2017");
...
b13.displayMessage(); System.out.println("=====================================");
Perpus b14 = new Perpus();
b14.setJudul("Seperti Dendam, Rindu Harus Dibayar Tuntas"); b14.setKategori("Fiksi");
b14.setPenulis("Eka Kurniawan");
b14.setPenerbitan("Gramedia Pustaka Utama 2019"); b14.setBahasa("Indonesia");
b14.setEdisi("-");
b14.setHalaman(257);
...
b14.displayMessage(); System.out.println("=====================================");
b1.ItungKesamaan(b2);
...
System.out.println("File telah berhasil disimpan"); System.out.println("\n");
