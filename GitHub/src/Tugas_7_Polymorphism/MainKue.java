...
kue[18] = new KueJadi("Klepon", 3000, 7); kue[19]
= new KueJadi("Kue Sus", 5000, 8); for (Kue i :
kue) {
...
System.out.println("Total harga kue jenis kue Jadi = "
+(int) hasil);
System.out.println("Total jumlah kue jenis kue Jadi = "
+ (int)totalBeratJumlah);
double hargaMax = 0;
int indexKue = 0;
System.out.println("\n");
